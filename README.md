...
* Первое лекционное занятие состоится во вторник, 5 октября, в 16:30 онлайн в Zoom (ссылка будем разослана в соотв. канале)
...
Курс читается по вторникам в 16:30 (теория) и 18:00 (практика) онлайн в Zoom. 
...
| ------------- | ------------- | -------------                                     | -------------                           | ------------- |
| 01            | 05.10.2020    | Вводная лекция. Кросс-валидация, дилемма смещения-разброса | Вводное занятие. Кросс-валидация | |
